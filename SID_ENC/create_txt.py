...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, default='/home/jieh/Dataset/Continous/Exposure/valid/input/Exp5/', metavar='PATH', help='root dir to save low resolution images')
    ...
    parser.add_argument('--target', type=str, default='/home/jieh/Dataset/Continous/Exposure/valid/target/', metavar='PATH', help='root dir to save high resolution images')
    parser.add_argument('--output', type=str, default='/home/jieh/Projects/Continous/UEN_SID/data/', metavar='PATH', help='output dir to save group txt files')

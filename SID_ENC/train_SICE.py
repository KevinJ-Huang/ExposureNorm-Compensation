...
import logging
import sys
sys.path.append('/home/jieh/Projects/Continous/UEN_SID')
...
def main():
    ...
    parser.add_argument('--opt', type=str, default='/home/jieh/Projects/Continous/UEN_SID/options/train/train_Enhance_SICE.yml',
    ...
    # # # #
        ...
        if opt['datasets'].get('val', None) and epoch % opt['train']['val_epoch'] == 0:
            ...
            for val_data in val_loader:
                ...
                model.test(idx,img_name.split('/')[-2])
                # model.compute_M1(idx,img_name.split('/')[-2])
            ...
            avg_psnr_all = avg_psnr_exp1 + avg_psnr_exp2
            # log
            logger.info('# Validation # PSNR: Over {:.4e}, Low {:.4e} '.
                        format(avg_psnr_exp1 / 30.0, avg_psnr_exp2 / 30.0))
            logger.info(

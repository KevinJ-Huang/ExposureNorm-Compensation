...
import logging
import sys
sys.path.append('/home/jieh/Projects/Continous/UEN')
...
def main():
    ...
    parser.add_argument('--opt', type=str, default='/home/jieh/Projects/Continous/UEN_DRBN/options/train/train_Enhance_SICE.yml',
